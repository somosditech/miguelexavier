...
if (!function_exists('vite_asset')) {
     ...
     * @param string $manifestPath Caminho para o manifest.json
     * @return string|null
     */
    function vite_asset($entry, $manifestPath = 'admin-assets/.vite/manifest.json')
    {
...
if (!function_exists('vite_js')) {
     ...
     *
     * @param string $entry Nome do arquivo de entrada (ex: 'main.jsx')
     * @param string $baseUrl URL base dos assets (ex: '/admin-assets/')
     * @return string|null
     */
    function vite_js($entry, $baseUrl = '/admin-assets/')
    {
...
if (!function_exists('vite_css')) {
     ...
     * @return string|null
     */
    function vite_css($entry, $baseUrl = '/admin-assets/')
    {
        $asset = vite_asset($entry);
