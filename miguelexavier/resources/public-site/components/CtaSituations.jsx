 ...
 */
const CtaSituations = () => {
    // Busca informações de contato da API
    ...
    // Fallback para as situações se não houver no banco
    ...
    const title = data?.title || "VOCÊ ESTÁ PASSANDO POR ALGUMAS DESSAS SITUAÇÕES?";
