...
// Conteúdo do site (200 requisições por minuto - permite ~20 visitantes simultâneos)
Route::prefix('content')->middleware('throttle.custom:200,1')->group(function () {
...
// Formulário de contato (7 envios por hora + honeypot)
